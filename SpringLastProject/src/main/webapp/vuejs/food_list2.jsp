...
<body>
	<div class="container-fluid">
		...
		<div class="col-sm-4" v-show="isShow">
			...
			<!-- v-bind:props명="data(){}변수명" -->
			
			<!-- 
			<table class="table">
				<tr>
					<td width="30%" clas="text-center" rowspan="7">
						<img :src="'http://www.menupan.com'+detail.poster" style="width:100px;">
					</td>
					<td colspan="2">
			...
			methods:{
				...
				detailData(fno){
					...
					axios.get('../food/detail_vue.do',{
						...
						console.log(error.response) //ex.getMeassage()
					})
				}
			},
			components:{
