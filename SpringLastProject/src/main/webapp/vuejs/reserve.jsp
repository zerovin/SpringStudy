...
<body>
	<div class="container">
		<div class="row">
			<table class="table">
				<tr>
					<td class="text-center" width="25%" height="500">
							...
							<table class="table">
								...
								<tr v-for="(vo, index) in food_list" class="nav-link" @click="foodSelect(index)">
									<td class="text-center" width="30%">
										<img :src="'http://www.menupan.com'+vo.poster" style="width:20px;height:30px;">
									</td>
				...
				<tr>
					<td class="text-center" width="40%" height="200">
						<table class="table" v-show="isTime">
							...
							<tr>
								<td>
									<span class="btn btn-xs btn-danger" style="margin-left:2px;" v-for="t in rtime" @click="timeSelect(t)">{{t}}</span>
								</td>
							</tr>
						</table>
					</td>
		...
		let rApp=Vue.createApp({
			data(){
				return{
					...
					food_detail:{},
					rday:'',
					rtime:['10:00','11:00','12:00','13:00','14:00','15:00','16:00','17:00','18:00','19:00','20:00','21:00'],
					ts:'',
