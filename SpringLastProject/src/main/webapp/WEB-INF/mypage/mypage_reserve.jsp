...
<body>
	<div id="mypageApp">
			...
			<tr>
				...
				<td colspan="2">
					<h4>{{reserve_info.fvo.name}}&nbsp;
						<span style="color:orange;">{{reserve_info.fvo.score}}</span>
					</h4>
				</td>
			</tr>
			<tr>
		...
		<table class="table" v-if="isShow">
			...
			<tr>
				<td width="20%" class="text-center">예약번호</td>
				<td width="80%">{{reserve_info.rno}}</td>
			</tr>
			<tr>
				<td width="20%" class="text-center">예약일</td>
				<td width="80%">{{reserve_info.rday}}</td>
			</tr>
			<tr>
				<td width="20%" class="text-center">예약시간</td>
				<td width="80%">{{reserve_info.rtime}}</td>
			</tr>
			<tr>
				<td width="20%" class="text-center">예약인원</td>
				<td width="80%">{{reserve_info.rinwon}}</td>
			</tr>
			<tr>
				<td width="20%" class="text-center">신청일</td>
