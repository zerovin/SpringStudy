            	...
            	<form method="post" action="../member/join_ok.do" @submit="submitform()">
				    <table class="table">
					     <tr>
					     	...
					     	<td width="80%">
					       		<input type="text" size=20 class="input-sm" v-bind:readonly="isReadOnly" name="userId" ref="userId" v-model="userId">
					     ...
					     <tr>
					      	...
					      	<td width="80%">
					       		<input type="password" size=20 class="input-sm" name="userPwd" ref="userPwd" v-model="userPwd" @keyup="pwdValidate()">
					       		&nbsp;재입력:<input type="password" size=20 class="input-sm" ref="userPwd2" v-model="userPwd2" @keyup="pwdValidate2()">
					       		<p>{{pwdOk}}</p>
					      	</td>
					     </tr>
					     <tr>
					     ...
					     <tr>
					      	...
					      	<td width="80%">
					       		<input type="text" size=70 class="input-sm" name="email" ref="email" v-model="email">
					      	</td>
					     </tr>
					     <tr>
    		...
    		methods:{
    			pwdValidate(){
    				...
    				if(pwd.length<8 || pwd.length>20){
    					...
    					return
    				}else if(pwd.search(/\s/)!=-1){ // \s => 공백, 공백이 있다면
    			...
    			submitform(e){
    				...
    				e.preventDefault() //유효성 검사 끝나고 prevent
    			},
    			postFind(){
    				let _this=this
    				new daum.Postcode({
